...
#Creamos la variable Parking para ver qué personas han usado el aparcamiento del supermercado


ids_con_parking <- unique(observaciones$ticket_id[observaciones$Alimento == "PARKING"])

observaciones <- observaciones %>% mutate(Parking = if_else(ticket_id %in% ids_con_parking, "SI", NA_character_))
