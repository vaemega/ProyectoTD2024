...
| Cantidad      | Cantidad comprada de x alimento                               |
| Precio        | Precio del alimento                                           |
| HoraCompra    | Hora de la compra                                             |
| FechaCompra   | Fecha compra, formato: DD/MM/YYYY                             |
| Direccion     | Dirección del supermercado donde se ha realizado la compra    |
| MetodoPago    | Método de pago de la compra                                   |
| HoraEntrada   | Hora de entrada (solo aparecerá si tiene parking)             |
| HoraSalida    | Hora de salida (solo aparecerá si tiene parking)              |
| PrecioParking | Precio parking                                                |
| CodigoPostal  | Codigo postal de la ciudad donde está ubicado el supermercado |
| Parking       | Si durante la compra ha utilizado el parking                  |
| Intervalo     | Intervalo de tiempo de uso del parking                        |
| Ciudad        | Ciudad en la que se encuentra el supermercado                 |
...
En resumen, nuestro conjunto de datos está formado por 1478 observaciones y 14 variables.
```{r echo=TRUE, warning=FALSE}
...
ggplot(top_5_productos, aes(x = Alimento, y = Cantidad_Total, fill = Alimento)) +
    ...
    labs(title = "Productos más comprados por Cantidad Total", x = "Alimento", y = "Cantidad Total") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
