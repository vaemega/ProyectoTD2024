...
Esto puede ayudar a los supermercados a ajustar sus precios o estrategias promocionales para ser más competitivos.
Comprender cómo la variación de precios entre supermercados influye en los hábitos de compra.
Por ejemplo, si los consumidores prefieren viajar más lejos para obtener mejores precios o si la comodidad supera el ahorro.
...
**Figura 2. Gráfico de barras para los Productos populares.** El eje horizontal (X) muestra los nombres de los productos ("Alimento").
...
En resumen, la bolsa plástica es el producto más comprado, mientras que el plátano, bebida soja café, jamón c.extra, y banana tienen aproximadamente la misma cantidad comprada.

**Figura 3. Gráfico de barras para la frecuencia de los Productos populares.** El gráfico 3 muestra los 5 productos ("Alimento") más frecuentemente comprados en el eje horizontal (X).
...
**Figura 4. Gráfico de barras sobre el uso del parking.** La información que hemos recopilado sobre el uso del aparcamiento por parte de los clientes que han adquirido tickets electrónicos es un dato interesante y puede revelar varias tendencias o patrones de comportamiento.
...
**Figura 6. Gráfico de barras sobre los intervalos horarios del uso del parking.** El histograma que hemos creado y los datos que refleja sobre las franjas horarias de entrada al aparcamiento pueden proporcionar varias conclusiones interesantes: El hecho de que el intervalo de 18:00-21:30 sobresalga indica que es el momento más popular para visitar el supermercado.
...
Para calcular el gasto promedio emplearemos esta sencilla fórmula $\frac{gasto \space total}{número \space de \space tickets}$, en donde tenemos un total de 4545.18 euros gastados y 108 tickets de compra: gasto medio = $\frac{4545.18}{108} = 42.085€$
...
**Figura 8. Histograma sobre el precio de compra.** De esta manera, es fácil ver que muchas compras no superan los 25 euros.Este suceso puede deberse a que entre semana, los compradores solo adquieren productos básicos de higiene,limpieza y comida, mientras que los fines de semana es cuando se adquiere mayor cantidad de productos , lo que conlleva un mayor gasto de compra.
...
**Figura 9. Diagrama de barras para la variable Ciudad.** Podemos observar en el gráfico de barras que la ciudad con más ventas es Valencia.Esta información puede ser de utilidad para: -Ubicación de tiendas: Si identificas las zonas geográficas donde se concentran la mayoría de las compras, esto puede indicar la demanda en áreas específicas.
...
**Figura 10. Diagrama de barras para la variable HoraCompra.** Tal y como se aprecia en el gráfico, la hora más común de compra es a las 20 y la menos común a las 21.
Esta información puede ser útil para: -Optimización del personal: Saber cuándo hay más afluencia de clientes puede ayudar a programar los turnos de los empleados de manera más eficiente.
...
En conclusión, el desarrollo de este proyecto sobre la extracción de información de tickets del supermercado Mercadona ha sido todo un reto para nosotros ya que es la primera vez que nos enfrentabamos a un trabajo de este tipo.Desde el inicio del proyecto, abordamos diversas cuestiones sobre el conjunto de datos, desde la distribución de variables numéricas como el precio de compra, hasta la exploración de relaciones entre diferentes variables como la relación entre el precio y la cantidad vendida.
