...
#Creamos el gráfico
ggplot(observaciones_parking_noNA, aes(x = HoraEntrada)) +
  geom_histogram(breaks = seq(min(observaciones_parking_noNA$HoraEntrada),
                              max(observaciones_parking_noNA$HoraEntrada),
                              by = "1 hour"), # Ajusta el intervalo según sea necesario
  col = "black", fill = "blue") + # Personaliza los colores según prefieras
  xlab("Hora de Entrada") +
  ylab("Frecuencia") +
  ggtitle("Distribución de Horas de Entrada al Parking") +
  theme_minimal()
