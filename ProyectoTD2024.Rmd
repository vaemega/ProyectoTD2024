...
author: Sergio Taengua Díaz, Valentina Elisa Medina Gallazzi, Narcis Casian Romega,
  Sheida Zolfaghari y Adrián Yuste Rebollo
date: "`r Sys.Date()`"
output:
...
En resumen, nuestro conjunto de datos está formado por 1751 observaciones y 13 variables.
...
Para calcular el gasto promedio emplearemos esta sencilla fórmula $\frac{gasto \space total}{número \space de \space tickets}$, en donde tenemos un total de 4537.81 euros gastados y 107 tickets de compra: gasto medio = $\frac{4537.81€}{107} = 42.41€$
...
**Figura 5. Diagrama de barras para la variable HoraCompra.** Tal y como se aprecia en el gráfico, la hora más común de compra es a las 20 y la menos común a las 13.
...
En conclusión, el desarrollo de este proyecto sobre la extracción de información de tickets del supermercado Mercadona
ha sido todo un reto para nosotros ya que es la primera vez que nos enfrentabamos a un trabajo de este tipo.Desde el inicio del proyecto, abordamos diversas cuestiones sobre el conjunto de datos, desde la distribución de variables numéricas como el precio de compra, hasta la exploración de relaciones entre diferentes variables como la relación entre el precio y la cantidad vendida.

Todo ello nos ha proporcionado un conocimiento sólido sobre el problema en un corto período de tiempo, sin necesidad de especializarnos como expertos en el campo. Además, nos hemos enfrentado a desafíos comunes en el análisis de datos, como la falta de datos o errores en los mismos, lo que nos ha permitido desarrollar habilidades para abordar estos problemas de manera efectiva.
