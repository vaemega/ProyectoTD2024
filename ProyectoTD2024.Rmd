...
df <- data.frame(Alimento = descripcion, Cantidad = cantidad, Precio = precio, HoraCompra = HoraCompra, FechaCompra = FechaCompra, Direccion = Direccion, codigo = cod, MetodoPago = MetodoPago, HoraEntrada = vector_entrada, HoraSalida = vector_salida)
